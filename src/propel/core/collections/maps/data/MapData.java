 ...
 * These values can be used in initializing Dictionaries, hashtables and other map-type data structures.
 * This would typically be done in serialization and de-serialization of these types of more complex data structures.
 */
		...
		implements IMapData<TKey, TValue>
{
	...
	public Iterator<KeyValuePair<TKey, TValue>> iterator()
	{
		if(keys.size() != values.size())
			throw new IllegalStateException("Cannot enumerate if the key count (" + keys.size() + ") is not equal to the value count (" + values.size() + ")");
