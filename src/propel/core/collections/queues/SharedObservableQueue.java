		...
		implements IObservableSubject<T>
{
	...
	/**
	 * How to behave upon a observer notification exceptions.
	 * Not thread-safe, set with care!
	 */
	private ObserverFailureHandlingMode observerFailureHandling;

	/**
	 * Default constructor. The default observer failure behaviour is to throw the exception.
	 * See ObserverFailureHandling for more details.
	 *
	...
	/**
	 * Clears the queue after notifying all observers of this.
	 * This is an O(n) operation in terms of elements and O(n) in terms of observers.
	 *
	 * @throws ObserverNotificationException When an observer fails to be notified and the notification failure behaviour is set to throw the exception.
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * Enqueues an object.
	 * This is an O(1) operation in terms of elements and O(n) in terms of observers.
	 *
	 * @throws ObserverNotificationException When an observer fails to be notified and the notification failure behaviour is set to throw the exception.
	 */
	@Override
	...
	/**
	 * Dequeues a number of objects, blocking if next are not available.
	 * This is an O(n) operation in terms of elements and O(n) in terms of observers.
	 *
	...
	/**
	 * Removes a previously added observer, it will no longer be notified of changes in a collection.
