...
/**
 * Used as a predicate for filtering out null values e.g. str => str != null
 */
public class NotNullSelector<T>
		extends Predicate<T>
{
	/**
	 * Default constructor
	 ...
	 */
	public NotNullSelector(Class<?> genericTypeParameter)
	{
