...
/**
 * Superclass of concrete predicate implementations concerning inequality, <, > comparisons.
 * Not meant to be used directly.
 */
public abstract class AbstractInequalitySelector<T extends Comparable<T>>
		extends AbstractSelector<T>
{
	 ...
	 */
	protected AbstractInequalitySelector(T comparator, NullHandling behaviour)
	{
	 ...
	 */
	protected AbstractInequalitySelector(T comparator, Class<?> genericTypeParameter, NullHandling behaviour)
	{
