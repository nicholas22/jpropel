...
/**
 * Predicate that is true for elements that are greater than a comparator.
 */
public class GreaterSelector<T extends Comparable<T>>
		extends AbstractInequalitySelector<T>
{
	 ...
	 */
	public GreaterSelector(T comparator)
	{
	 ...
	 */
	public GreaterSelector(T comparator, Class<?> genericTypeParameter)
	{
	 ...
	 * @throws SuperTypeTokenException When not instantiated using anonymous class semantics.
	 */
	public GreaterSelector(T comparator, NullHandling behaviour)
	{
	 ...
	 * @throws NullPointerException When the generic type parameter is null.
	 */
	public GreaterSelector(T comparator, Class<?> genericTypeParameter, NullHandling behaviour)
	{
