...
/**
 * Predicate that is false for elements matching a comparator.
 */
public class InequalitySelector<T extends Comparable<T>>
		extends AbstractInequalitySelector<T>
{
	/**
	 ...
	 */
	public InequalitySelector(T comparator)
	{
	 ...
	 */
	public InequalitySelector(T comparator, Class<?> genericTypeParameter)
	{
	 ...
	 * @throws SuperTypeTokenException When not instantiated using anonymous class semantics.
	 */
	protected InequalitySelector(T comparator, NullHandling behaviour)
	{
	 ...
	 * @throws NullPointerException When the generic type parameter is null.
	 */
	protected InequalitySelector(T comparator, Class<?> genericTypeParameter, NullHandling behaviour)
	{
