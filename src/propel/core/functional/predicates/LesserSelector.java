...
/**
 * Predicate that is true for elements that are less than a comparator.
 */
public class LesserSelector<T extends Comparable<T>>
		extends AbstractInequalitySelector<T>
{
	 ...
	 */
	public LesserSelector(T comparator)
	{
	 ...
	 */
	public LesserSelector(T comparator, Class<?> genericTypeParameter)
	{
	 ...
	 * @throws SuperTypeTokenException When not instantiated using anonymous class semantics.
	 */
	protected LesserSelector(T comparator, NullHandling behaviour)
	{
	 ...
	 * @throws NullPointerException When the generic type parameter is null.
	 */
	protected LesserSelector(T comparator, Class<?> genericTypeParameter, NullHandling behaviour)
	{
