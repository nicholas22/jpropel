...
/**
 * Predicate that is true for elements matching a comparator.
 */
public class EqualitySelector<T extends Comparable<T>>
		extends AbstractEqualitySelector<T>
{
	 ...
	 */
	public EqualitySelector(T comparator)
	{
	 ...
	 */
	public EqualitySelector(T comparator, Class<?> genericTypeParameter)
	{
	 ...
	 * @throws SuperTypeTokenException When not instantiated using anonymous class semantics.
	 */
	public EqualitySelector(T comparator, NullHandling behaviour)
	{
	 ...
	 * @throws NullPointerException When the generic type parameter is null.
	 */
	public EqualitySelector(T comparator, Class<?> genericTypeParameter, NullHandling behaviour)
	{
