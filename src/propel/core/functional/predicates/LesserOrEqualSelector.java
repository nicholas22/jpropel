...
/**
 * Predicate that is true for elements that are less than or equal to a comparator.
 */
public class LesserOrEqualSelector<T extends Comparable<T>>
		extends AbstractEqualitySelector<T>
{
	 ...
	 */
	public LesserOrEqualSelector(T comparator)
	{
	 ...
	 */
	public LesserOrEqualSelector(T comparator, Class<?> genericTypeParameter)
	{
	 ...
	 * @throws SuperTypeTokenException When not instantiated using anonymous class semantics.
	 */
	protected LesserOrEqualSelector(T comparator, NullHandling behaviour)
	{
	 ...
	 * @throws NullPointerException When the generic type parameter is null.
	 */
	protected LesserOrEqualSelector(T comparator, Class<?> genericTypeParameter, NullHandling behaviour)
	{
		super(comparator, genericTypeParameter, behaviour);
	}

	@Override
	public boolean compare(T element)
	{
