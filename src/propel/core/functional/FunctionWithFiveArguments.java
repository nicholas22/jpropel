...
/**
 * This encapsulates a generic function that accepts five arguments
 */
public abstract class FunctionWithFiveArguments<T1, T2, T3, T4, T5, TResult>
{
	...
	public FunctionWithFiveArguments()
	{
		...
		genericReturnTypeParameter = SuperTypeToken.getClazz(this.getClass(), 5);
	}

	public FunctionWithFiveArguments(Class<?> genericTypeParameter1, Class<?> genericTypeParameter2, Class<?> genericTypeParameter3, Class<?> genericTypeParameter4, Class<?> genericTypeParameter5, Class<?> genericReturnTypeParameter)
	{
	 ...
	 */
	public abstract TResult operateOn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5);
	...
	/**
	 * Returns the sixth generic type parameter used to initialize this class.
	 */
