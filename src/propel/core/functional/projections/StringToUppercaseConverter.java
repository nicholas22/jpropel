...
/**
 * Used as a null-coalescing string converter function i.e. x=> x != null ? x.toUpperCase() : null
 */
public final class StringToUppercaseConverter
		extends FunctionWithOneArgument<String, String>
{
	...
	public StringToUppercaseConverter(Locale locale)
	{
	...
	public String operateOn(String arg)
	{
		if(locale == null)
			...
			return arg != null ? arg.toUpperCase(locale) : null;
	}
}
