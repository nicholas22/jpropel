...
/**
 * This encapsulates a generic action that uses four arguments.
 */
public abstract class ActionWithFourArguments<T1, T2, T3, T4>
{
	...
	public ActionWithFourArguments()
	{
	...
	public ActionWithFourArguments(Class<?> genericTypeParameter1, Class<?> genericTypeParameter2, Class<?> genericTypeParameter3, Class<?> genericTypeParameter4)
	{
	 ...
	 * Execute the action
	 */
	public abstract void executeWith(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
