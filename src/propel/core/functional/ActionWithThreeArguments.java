...
/**
 * This encapsulates a generic action that uses three arguments.
 */
public abstract class ActionWithThreeArguments<T1, T2, T3>
{
	...
	public ActionWithThreeArguments()
	{
	...
	public ActionWithThreeArguments(Class<?> genericTypeParameter1, Class<?> genericTypeParameter2, Class<?> genericTypeParameter3)
	{
	 ...
	 * Execute the action
	 */
	public abstract void executeWith(T1 arg1, T2 arg2, T3 arg3);
