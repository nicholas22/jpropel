		...
		extends EncodedStringPropertyMetadata
{
	 ...
	 */
	public EncodedStrippedStringPropertyMetadata(String name, Iterable<Character> allowedCharacters, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noNullChars)
	{
