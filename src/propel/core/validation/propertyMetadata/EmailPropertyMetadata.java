		...
		extends StringPropertyMetadata
{
	...
	/**
	 * Initializes an email address with default RFC-specified constraints and whether to allow international characters and domain name omission.
	 *
	 ...
	 * @throws IllegalArgumentException An argument is null
	 */
	public EmailPropertyMetadata(String name, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noUnicodeChars, boolean localPartOnlyAllowed)
	{
	 ...
	 * @throws IllegalArgumentException An argument is null
	 */
	public EmailPropertyMetadata(String name, int minLength, int maxLength, int minLocalPartLength, int maxLocalPathLength, int minDomainLength, int maxDomainLength, boolean notNull, boolean notEmpty, boolean noUnicodeChars, boolean localPartOnlyAllowed)
	{
		super(name, minLength, maxLength, notNull, notEmpty, true);
		this.localPartOnlyAllowed = localPartOnlyAllowed;
		this.localPartPropMeta = new EmailLocalPartPropertyMetadata(name + LOCAL_PART, minLocalPartLength, maxLocalPathLength, true, true, noUnicodeChars);
	 ...
	 * @throws IllegalArgumentException An argument is null
	 */
	public EmailPropertyMetadata(String name, int minLength, int maxLength, EmailLocalPartPropertyMetadata localPartPropMeta, DomainPropertyMetadata domainPartPropMeta, boolean notNull, boolean notEmpty, boolean localPartOnlyAllowed)
	{
		super(name, minLength, maxLength, notNull, notEmpty, true);
