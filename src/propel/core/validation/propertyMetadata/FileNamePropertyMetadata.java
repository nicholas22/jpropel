		...
		extends RestrictedEdgesI18NStringPropertyMetadata
{
	...
	/**
	 * Whether a windows file name.
	 * This is null if not specified, in which case we use the current OS.
	 */
	...
	{
		this(name, ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_DISALLOWED_FILENAME_CHARS), ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_DISALLOWED_FILENAME_START_CHARS), ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_DISALLOWED_FILENAME_END_CHARS), minLength, maxLength, notNull, notEmpty, false, windowsFilename);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public FileNamePropertyMetadata(String name, Iterable<Character> disallowedChars, Iterable<Character> disallowedStartChars, Iterable<Character> disallowedEndChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noUnicodeChars, Boolean windowsFilename)
	{
