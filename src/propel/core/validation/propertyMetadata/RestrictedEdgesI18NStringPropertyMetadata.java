...
/**
 * Class aiding in validation of internationalised (i18n) strings, limiting the content from containing
		...
		extends RestrictedEdgesStringPropertyMetadata
{
	 ...
	 */
	public RestrictedEdgesI18NStringPropertyMetadata(String name, Iterable<Character> disallowedChars, Iterable<Character> disallowedStartChars, Iterable<Character> disallowedEndChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noNullChars, boolean noUnicodeChars)
	{
