		...
		extends RestrictedEdgesI18NStringPropertyMetadata
{
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public UsernamePropertyMetadata(String name, Iterable<Character> disallowedChars, Iterable<Character> disallowedStartChars, Iterable<Character> disallowedEndChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noNullChars, boolean noUnicodeChars)
	{
		super(name, disallowedChars, disallowedStartChars, disallowedEndChars, minLength, maxLength, notNull, notEmpty, noNullChars, noUnicodeChars);
	}
}
