		...
		extends EncodedStringPropertyMetadata
{
	...
	{
		this(name, ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_ALLOWED_TEL_CHARS), minLength, maxLength, notNull, notEmpty);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public TelephonePropertyMetadata(String name, Iterable<Character> allowedChars, int minLength, int maxLength, boolean notNull, boolean notEmpty)
	{
