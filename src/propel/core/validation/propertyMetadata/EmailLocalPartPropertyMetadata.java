		...
		extends RestrictedEdgesI18NStringPropertyMetadata
{
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public EmailLocalPartPropertyMetadata(String name, Iterable<Character> disallowedChars, Iterable<Character> disallowedStartChars, Iterable<Character> disallowedEndChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noUnicodeChars)
	{
