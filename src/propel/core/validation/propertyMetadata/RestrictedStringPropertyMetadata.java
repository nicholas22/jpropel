		...
		extends StringPropertyMetadata
{
	 ...
	 */
	public RestrictedStringPropertyMetadata(String name, Iterable<Character> disallowedChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noNullChars)
	{
