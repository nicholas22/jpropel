		...
		extends RestrictedEdgesI18NStringPropertyMetadata
{
	...
	{
		this(name, ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_DISALLOWED_SUBDOMAIN_CHARS), ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_DISALLOWED_SUBDOMAIN_START_CHARS), ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_DISALLOWED_SUBDOMAIN_END_CHARS), minLength, maxLength, notNull, notEmpty, noUnicodeChars);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public SubDomainPropertyMetadata(String name, Iterable<Character> disallowedCharacters, Iterable<Character> disallowedStartChars, Iterable<Character> disallowedEndChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noUnicodeChars)
	{
		super(name, disallowedCharacters, disallowedStartChars, disallowedEndChars, minLength, maxLength, notNull, notEmpty, true, noUnicodeChars);
	}
