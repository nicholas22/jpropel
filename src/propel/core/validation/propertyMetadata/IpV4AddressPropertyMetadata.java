		...
		extends EncodedStringPropertyMetadata
{
	...
	{
		this(name, ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_ALLOWED_IPV4_CHARS), DEFAULT_MIN_IPV4_LENGTH, DEFAULT_MAX_IPV4_LENGTH, notNull, notEmpty);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public IpV4AddressPropertyMetadata(String name, Iterable<Character> allowedChars, int minLength, int maxLength, boolean notNull, boolean notEmpty)
	{
