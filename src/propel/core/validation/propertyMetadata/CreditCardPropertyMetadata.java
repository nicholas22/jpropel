		...
		extends EncodedStringPropertyMetadata
{
	...
	{
		this(name, ArrayUtils.boxChars(StringUtils.charRange(48, 58)), DEFAULT_MIN_CREDITCARD_LENGTH, DEFAULT_MAX_CREDITCARD_LENGTH, notNull, notEmpty);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public CreditCardPropertyMetadata(String name, Iterable<Character> allowedChars, int minLength, int maxLength, boolean notNull, boolean notEmpty)
	{
	...
	/**
	 * Very fast Luhn algorithm for checking credit card number validity.
	 * Thanks to Thomas @ Orb of Knowledge:
