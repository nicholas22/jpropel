...
/**
 * Class aiding in validation of strings, limiting the content from containing certain characters
 * and disallowing certain characters from being at the beginning or end of the string.
 */
		...
		extends RestrictedStringPropertyMetadata
{
	 ...
	 */
	public RestrictedEdgesStringPropertyMetadata(String name, Iterable<Character> disallowedChars, Iterable<Character> disallowedStartChars, Iterable<Character> disallowedEndChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noNullChars)
	{
