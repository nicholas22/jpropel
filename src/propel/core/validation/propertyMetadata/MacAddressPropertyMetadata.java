		...
		extends EncodedStrippedStringPropertyMetadata
{
	...
	{
		this(name, ConfigurableParameters.tryGetIterable(ConfigurableConsts.VALIDATION_ALLOWED_MAC_CHARS), DEFAULT_MIN_MAC_LENGTH, DEFAULT_MAX_MAC_LENGTH, notNull, notEmpty);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public MacAddressPropertyMetadata(String name, Iterable<Character> allowedChars, int minLength, int maxLength, boolean notNull, boolean notEmpty)
	{
