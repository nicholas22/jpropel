		...
		extends StringPropertyMetadata
{
	...
	{
		this(name, minLength, maxLength, SubDomainPropertyMetadata.DEFAULT_MIN_SUBDOMAIN_LENGTH, SubDomainPropertyMetadata.DEFAULT_MAX_SUBDOMAIN_LENGTH, DEFAULT_SUBDOMAIN_NAME_POSTFIX, notNull, notEmpty, noUnicodeChars);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public DomainPropertyMetadata(String name, int minLength, int maxLength, int minSubDomainLength, int maxSubDomainLength, String subDomainNamePostfix, boolean notNull, boolean notEmpty, boolean noUnicodeChars)
	{
		super(name, minLength, maxLength, notNull, notEmpty, true);
		subDomainPropMeta = new SubDomainPropertyMetadata(name + subDomainNamePostfix, minSubDomainLength, maxSubDomainLength, true, true, noUnicodeChars);
	}
	 ...
	 * @throws IllegalArgumentException An argument is invalid
	 */
	public DomainPropertyMetadata(String name, int minLength, int maxLength, SubDomainPropertyMetadata subDomainPropMeta, boolean notNull, boolean notEmpty)
	{
		super(name, minLength, maxLength, notNull, notEmpty, true);
