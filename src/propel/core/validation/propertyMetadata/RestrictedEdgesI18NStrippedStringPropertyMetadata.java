...
/**
 * Class aiding in validation of internationalised (i18n) strings, stripping from content
 * certain characters and disallowing certain characters from being at the beginning or end of the string.
 */
		...
		extends RestrictedEdgesI18NStringPropertyMetadata
{
	 ...
	 */
	public RestrictedEdgesI18NStrippedStringPropertyMetadata(String name, Iterable<Character> strippedChars, Iterable<Character> disallowedStartChars, Iterable<Character> disallowedEndChars, int minLength, int maxLength, boolean notNull, boolean notEmpty, boolean noNullChars, boolean noUnicodeChars)
	{
		super(name, strippedChars, disallowedStartChars, disallowedEndChars, minLength, maxLength, notNull, notEmpty, noNullChars, noUnicodeChars);
	}

	/**
	 * Validates the given value with the current constraints.
	 * Strips disallowed characters and returns validated result.
	 *
