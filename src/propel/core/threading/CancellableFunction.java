 ...
 */
public class CancellableFunction<T, TResult>
		extends CancellableTask<T, TResult>
{
	/**
	 ...
	 */
	public CancellableFunction(FunctionWithOneArgument<T, TResult> function, T state)
	{
		super(function, state, new SharedObservableQueue<ITaskResult<TResult>>(ITaskResult.class), new Cancellation());
	}
	 ...
	 */
	public CancellableFunction(FunctionWithOneArgument<T, TResult> function, T state, ICancellation cancellation)
	{
		super(function, state, new SharedObservableQueue<ITaskResult<TResult>>(ITaskResult.class), cancellation);
	}
}
